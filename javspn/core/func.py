...
def check_update(allow_check=True, auto_update=True):
    ...
    # 检查更新
    if allow_check:
        api_url = 'https://api.github.com/repos/glyh/JavSPn/releases/latest'
        release_url = 'https://github.com/glyh/JavSPn/releases/latest'
        print('正在检查更新...', end='')
        try:
    ...
    if update_status == 'disallow':
        ...
        release_url_mirror = 'https://hub.fastgit.xyz/glyh/JavSPn/releases/latest'
